  ...
  case "blue":
   ...
   case "blue-gray":
    if(starWarsCharacters[i].eye_color == "blue-gray") {
         blueGrayEyes.push(starWarsCharacters[i]);
    break;}
            

}
}
console.log("hanno gli occhi blu",blueEyes);
console.log("hanno gli occhi yellow",yellowEyes);
console.log("hanno gli occhi brown",brownEyes);
console.log("hanno gli occhi red",redEyes);
console.log("hanno gli occhi blu-gray",blueGrayEyes);
